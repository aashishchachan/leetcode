...
void strings(){
    ...
    string number = "4";
    int num = stoi(number);     // not able to use inside a class
    cout << num+5<<endl;
...
int main(){
    ...
    // using inbuilt min, max kind of functions take more time
    //asymptotically more efficient means it will perform better on large inputs. different from amortized. 
    return 0;
}